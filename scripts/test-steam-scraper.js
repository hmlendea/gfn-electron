...
// Mock the Discord RPC requirement to avoid initialization
const mockClient = {
  updatePresence: () => console.log('Mock Discord RPC update called')
};

// Override require for discord-rich-presence
const originalRequire = require;
require = function(id) {
  if (id === 'discord-rich-presence') {
    return () => mockClient;
  }
  return originalRequire.apply(this, arguments);
};

// Load the RPC module after mocking
